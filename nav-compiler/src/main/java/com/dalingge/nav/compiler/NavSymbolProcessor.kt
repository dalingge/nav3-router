...
class NavSymbolProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        screenSymbols.forEach { function ->
            ...
            val routeParams = function.parameters.filter { param ->
                ...
                !param.hasDefault && typeName != "com.dalingge.nav.runtime.Navigator"
            }
    ...
    private fun generateDestinationClass(
        ...
        val classBuilder = TypeSpec.classBuilder(className)
            .addSuperinterface(ClassName("com.dalingge.nav.runtime", "NavDestination"))
    ...
    private fun buildRegistryStatement(
        ...
        block.addStatement("com.dalingge.nav.runtime.NavRegistry.register(")
        block.indent()
        block.addStatement("com.dalingge.nav.runtime.RouteMeta(")
        block.indent()
    ...
    private fun generateRegistryFile(
        ...
        val navCenterClassName = ClassName("com.dalingge.nav.runtime", "NavCenter")

        FileSpec.builder("com.dalingge.nav.generated", fileName)
            .addFunction(
        ...
        logger.info("Successfully generated: com.dalingge.nav.generated.$fileName.kt")
    }
}
